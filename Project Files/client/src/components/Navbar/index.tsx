...
const openedMixin = (theme: Theme): CSSObject => ({
  ...
  overflowX: "hidden",
  background:
    "linear-gradient(160deg, rgba(255,255,255,0.95), rgba(245,248,255,0.9))",
    ...
    <Box sx={{ display: "flex" }} className="app-shell">
      ...
      <AppBar
        ...
        sx={{
          ...
          borderBottom: "1px solid rgba(30, 50, 90, 0.08)",
          boxShadow: "0 10px 30px rgba(31, 47, 88, 0.08)",
        }}
      >
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }} className="app-main">
        <DrawerHeader />
        {children}
      </Box>
    </Box>
