...
const Login = () => {
            ...
            >
              <Box className="auth-card">
                <Box sx={{ marginBottom: "10px" }}>
                  <span className="soft-pill">Welcome Back</span>
                </Box>
                <Typography
                  sx={{
                    fontSize: "26px",
  ...
  <Box sx={{ display: "flex", justifyContent: "center", marginTop: "10px" }}>
    <Typography sx={{ color: "var(--muted)", fontSize: "15px" }}>
      New here?{" "}
      <Link to="/signup" style={{ fontWeight: "bold", color: "var(--text)", textDecoration: "none" }}>
  ...
  <Box sx={{ display: "flex", justifyContent: "end", marginTop: "10px" }}>
    <Button
      ...
      sx={{
        ...
        margin: "20px 0",
        background: "linear-gradient(120deg, #2f7bff, #11c48b)",
      }}
    >
